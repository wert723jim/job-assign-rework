<template>
  <header>
    ...
    <div class="dropdown float-right">
        ...
        <button class="btn  btn-sm  dropdown-toggle d-flex items-center" type="button" id="dropdownMenu2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
    ...
    <a class="float-right mr-2" href="http://www.qadmin.net" target="_blank">Qadmin官网</a>
    <a  class="float-right mr-2" href="http://docs.qadmin.net/" target="_blank">开发文档</a>
</header>
</template>
